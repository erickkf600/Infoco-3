  ...
  <div class="container" id="container">
    <div class="welcome-area">
      <div class="title-area">
        <h2 class="tittle">Bem Vindo a <span>InFoco</span></h2>
        ...
        <div class="welcome-content">
          <ul class="wc-table">
            <li class="col-lg-3 col-md-6 col-sm-6">
              <div class="single-wc-content wow fadeInUp fhd">
                <span class="fas fa-bullhorn wc-icon"></span>
                <h4 class="wc-tittle">Ganhe mais destaque</h4>
            ...
            <li class="col-lg-3 col-md-6 col-sm-6">
              <div class="single-wc-content wow fadeInUp fhd">
                <span class="fas fa-globe wc-icon"></span>
                <h4 class="wc-tittle">TENHA SEU PRÓPRIO SITE</h4>
            ...
            <li class="col-lg-3 col-md-6 col-sm-6">
              <div class="single-wc-content wow fadeInUp last fhd">
                <span class="fas fa-percent wc-icon"></span>
                <h4 class="wc-tittle">DESCONTOS EXCLUSIVOS</h4>
                <p>Todos os nossos parceiros recebem o cartões fidelidade para ganhar e promover descontos aos seus clientes.</p>
              </div>
            </li>
            <li class="col-lg-3 col-md-6 col-sm-6">
              <div class="single-wc-content wow fadeInUp">
                <span class="fas fa-network-wired wc-icon"></span>
                <h4 class="wc-tittle">NETWORKING</h4>
        ...
        <div class="about-area">
          <div class="row">
            <div class="col-md-5 col-sm-6 col-xs-12">
              <iframe width="100%" height="315" src="https://www.youtube.com/embed/gDhmMQs15zs?rel=0&controls=0&loop=1&playlist=gDhmMQs15zs" allow="accelerometer; autoplay; gyroscope" frameborder="0"></iframe>
            </div>
            <div class="col-md-7 col-sm-6 col-xs-12">
              <div class="about-right wow fadeInRight">
                <div class="title-area">
                  <h2 class="tittle">Um pouco sobre a <span>InFoco</span></h2>
                  <span class="tittle-line"></span>
                  ...
                  <div class="about-btn-area">
                    <a href="adesao.php" class="button button-default" data-text="FAÇA A SUA ADESÃO"><span>FAÇA A SUA ADESÃO</span></a>
                  </div>                    
                </div>
              </div>
            </div>
